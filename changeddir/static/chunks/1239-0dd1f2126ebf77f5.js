    ...
    1239: function (e, t, n) {
      ...
      var s = (function (e) {
        function t(e) {
          ...
          return (
            (n.state = { isOpen: !1, modalVideoWidth: "100%" }),
          ...
          o(
            ...
            [
                ...
                value: function () {
                  ...
                  clearTimeout(this.timeout),
                    (this.timeout = setTimeout(function () {
                      var t = e.getWidthFulfillAspectRatio(
                        e.props.ratio,
                        window.innerHeight,
                        window.innerWidth
                      );
                      e.state.modalVideoWidth != t &&
                        e.setState({ modalVideoWidth: t });
                    }, 10));
                },
              },
              {
              ...
              },
              {
                ...
                value: function () {
                  var e = this,
                    t = { width: this.state.modalVideoWidth },
      ...
      var f = (function (e) {
        ...
        function o(t, n) {
          ...
          return (
            ...
            t.in
              ? r
                ? ((a = u), (o.appearStatus = p))
                : (a = c)
              : (a = t.unmountOnExit || t.mountOnEnter ? l : u),
            (o.state = { status: a }),
            (o.nextCallback = null),
            o
          );
