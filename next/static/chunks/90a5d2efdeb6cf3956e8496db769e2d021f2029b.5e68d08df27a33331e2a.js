      ...
      var M = (function () {
        function t(e, r, n, o) {
          ...
          a(this, t),
            ...
            (this.pathname = e),
            (this.query = r);
          var b = (0, p.isDynamicRoute)(e) && self._next_DATA__.autoExport;
          (this.asPath = b ? e : n),
            (this.basePath = ""),
            (this.sub = m),
            (this.clc = null),
                        ...
                        for (;;)
                          switch ((e.prev = e.next)) {
                              ...
                              throw new Error(
                                (G
                                  ...
                                  : "The provided `as` value ("
                                      ...
                                      .concat(D, "). ")) +
                                  "Read more: https://err.sh/vercelnext.js/".concat(
                                    G
                            ...
                            case 114:
                              ...
                              throw (
                                (t.events.emit("routeChangeError", z, w, g), z)
                              );
                            case 117:
                              return (
